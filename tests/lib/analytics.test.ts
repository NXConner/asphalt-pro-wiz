...
import { trackEvent, trackPageView, trackError, trackTiming, trackUserAction } from '@/lib/analytics';
...
describe('Analytics', () => {
  ...
  describe('trackError', () => {
    it('should track errors with context', () => {
      ...
      expect(logEvent).toHaveBeenCalledWith('error', expect.objectContaining({
