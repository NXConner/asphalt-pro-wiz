...
export function useJobState() {
  ...
  const ensureJobPersisted = useCallback((address: string, coords: [number, number] | null) => {
  ...
  const handleAddressUpdate = useCallback((coords: [number, number], address: string) => {
