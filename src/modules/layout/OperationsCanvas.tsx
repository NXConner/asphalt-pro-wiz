...
export function OperationsCanvas({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-repeat opacity-30" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='720' height='720' viewBox='0 0 720 720' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd' opacity='0.12'%3E%3Cpath d='M0 720h720V0H0z'/%3E%3Cpath d='M360 0v720M0 360h720' stroke='%23ffffff' stroke-opacity='0.08' stroke-width='2'/%3E%3C/g%3E%3C/svg%3E")` }} />
