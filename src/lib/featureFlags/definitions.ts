...
const FEATURE_FLAG_DEFINITIONS_RAW = [
  ...
  {
    id: 'estimatorCopilot',
    label: 'Estimator Copilot & Scenario Intelligence',
    description:
      'Unlock AI-assisted recommendations, scenario comparison matrices, and exportable insights for proposal reviews.',
    category: 'estimator',
    defaultValue: true,
    envVar: 'VITE_FLAG_ESTIMATOR_COPILOT',
    supabaseKey: 'estimatorCopilot',
    telemetryKey: 'estimator_copilot',
    tags: ['ai', 'analytics', 'estimation'],
    surfaces: ['EstimatorStudio'],
  },
  {
    id: 'supplierIntelV2',
