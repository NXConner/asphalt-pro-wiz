...
export const PREMIUM_SERVICES: ServiceDefinition[] = [
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Install new asphalt overlay to refresh surface and extend pavement life.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Mill high spots or full lanes to improve cross-slope and tie-in elevations.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Excavate soft subgrade, install stone, and compact to restore load capacity.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Prime severe oil spots with specialty primers for superior sealer adhesion.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Install durable thermoplastic arrows, ADA symbols, and specialty markings.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Broadcast glass beads into wet paint for night-time retroreflectivity.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Install reflective RPMs where desired for channelization and safety.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Install new bollards or sleeves for protection at entries and equipment.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Provide posts, bases, and MUTCD-compliant signs installed to spec.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Install prefabricated or asphalt-formed traffic calming features with markings.',
    justification:
      'Materials, layout, and safety coordination add cost; improves campus safety.',
    unitType: 'perUnit',
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Construct asphalt berms or curbing to control runoff and protect landscaping.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Capture aerial imagery for condition assessment and polished client reporting.',
    justification:
  ...
  },
  {
    ...
    justification:
      'Premium labor rates and logistics coordination for off-hours service delivery.',
    unitType: 'flat',
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Accelerated scheduling and procurement to start sooner than standard lead times.',
    justification:
      'Overtime, priority logistics, and supplier coordination carry premium costs.',
    unitType: 'flat',
    defaultUnitPrice: 250,
    defaultQuantityStrategy: 'one',
    tags: ['scheduling'],
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Extended workmanship coverage with one scheduled annual maintenance visit.',
    justification:
  ...
  },
  {
    ...
    justification:
      'Specialized equipment and additional mobilization protect coating performance.',
    unitType: 'flat',
    defaultUnitPrice: 150,
    defaultQuantityStrategy: 'one',
    tags: ['prep', 'weather'],
  },
  {
    ...
    category: 'premium',
    description:
      'Install relief cuts to redirect standing water and improve drying.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Repair or reconstruct basin frames, lids, and surrounding asphalt as needed.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Remove unwanted paint lines prior to reconfiguration and restriping.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Apply colorized sealer for walkways, play areas, or aesthetic zones.',
    justification:
      'Special pigments and multi-coat systems add material and labor complexity.',
    unitType: 'perSqFt',
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Upgrade aggregate package for improved traction and durability.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Apply pre-emergent to inhibit new growth under and around pavement edges.',
    justification:
      'Timing and licensed application extend the life of crack sealing and edges.',
    unitType: 'perSqFt',
  ...
  },
  {
    ...
    justification:
      'Material and labor improve performance and aesthetics at pavement interfaces.',
    unitType: 'perLinearFt',
    defaultUnitPrice: 8,
    defaultQuantityStrategy: 'crackLength',
    tags: ['drainage', 'landscape'],
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Coordinate phases around services, weddings, and events to minimize disruption.',
    justification:
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Provide an as-built sketch/CAD for records and future facility planning.',
    justification:
  ...
  },
  {
    ...
    justification:
      'Preparation time and documentation support formal procurement and compliance.',
    unitType: 'flat',
  ...
  },
  {
    ...
    category: 'premium',
    description:
      'Urgent cold-mix patching to eliminate hazards ahead of permanent repair.',
    justification:
      'Rapid response and on-hand materials mitigate risk and liability.',
    unitType: 'perUnit',
    defaultUnitPrice: 65,
    defaultQuantityStrategy: 'units',
    tags: ['safety', 'repair'],
  },
  {
    ...
    justification:
      'Protective hardware reduces seasonal damage and repaint costs.',
    unitType: 'perUnit',
    defaultUnitPrice: 12,
    defaultQuantityStrategy: 'units',
    tags: ['winter'],
